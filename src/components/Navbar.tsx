      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 flex items-center justify-between">
        ...
        <div id="desktop-actions" className="hidden lg:flex items-center space-x-3">
          <a
            ...
            className="px-6 py-2.5 bg-indigo-600 text-white text-xs font-extrabold uppercase tracking-widest rounded-full shadow-lg shadow-indigo-200/50 hover:bg-indigo-700 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 cursor-pointer inline-block"
          >
            Consultation
          </a>
        </div>
        ...
        <div id="mobile-toggle" className="lg:hidden flex items-center">
          <button
            ...
            className="text-slate-700 hover:text-indigo-600 focus:outline-none cursor-pointer"
          >
          ...
          >
            <div className="px-6 py-6 flex flex-col space-y-4">
              ...
              <a
                ...
                className="w-full inline-flex items-center justify-center space-x-2 bg-indigo-600 text-white text-sm font-semibold uppercase tracking-wider py-3.5 rounded-lg hover:bg-slate-900 transition-colors duration-300 text-center"
              >
