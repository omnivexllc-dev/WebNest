        ...
        >
          {SERVICES_DATA.map((service) => {
            ...
            return (
              ...
              >
                <ThreeDCard 
                  className="group h-full bg-white border border-slate-200/60 rounded-3xl p-6 hover:border-blue-600 transition-all duration-300 flex flex-col justify-between shadow-sm shadow-slate-100"
                  intensity={10}
                >
