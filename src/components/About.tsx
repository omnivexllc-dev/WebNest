        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          >
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              WebNest is a premier <strong>Website Development Company</strong> and result-driven <strong>Digital Marketing Agency</strong>. We bridge the gap between creative visual design and rigorous <strong>Web Development Services</strong>, building bespoke interfaces curated directly to our clients&#39; commercial goals. Working with an expert <strong>Website Designer</strong> on our team guarantees your platform is crafted to represent your brand with utmost distinction, rank prominently on search engines, and convert visitors into long-term customer relationships.
            </p>

            <p className="text-slate-600 text-sm leading-relaxed">
              We specialize in custom <strong>E-commerce Website Development</strong>, high-performance <strong>Mobile App Development</strong>, secure web application structures, and growth-driven <strong>SEO Services</strong>. By leveraging React, next-gen TypeScript, robust Node.js APIs, and performance-tuned architectures, we ensure your brand maintains superior Google Web Vitals—loading in milliseconds, scaling effortlessly, and capturing organic clicks natively.
            </p>
