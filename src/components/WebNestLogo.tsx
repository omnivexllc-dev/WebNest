    ...
    >
        ...
        {isHovered && (
          <motion.div
            ...
            animate={{ 
              ...
              scale: [1, 1.25, 1],
              background: `radial-gradient(circle, ${glowColor} 0%, rgba(4, 120, 87, 0) 70%)`
            }}
      ...
      >
          ...
          <AnimatePresence>
            {isHovered && (
              ...
              >
                ...
                <line x1="18" y1="45" x2="102" y2="45" stroke="#10b981" strokeWidth="0.3" strokeDasharray="2 3" />
                {/* Vertical blueprint marker */}
                <line x1="60" y1="12" x2="60" y2="78" stroke="#10b981" strokeWidth="0.3" strokeDasharray="2 3" />
              </motion.g>
            )}
          </AnimatePresence>
        ...
        <g id="main-ribbons-and-folds" filter="url(#liquidHologramFilter)">
          ...
          {/* LEFT RIBBON (Crystalline Emerald/Mint fold) */}
          <motion.path
            d="M 26,22 
          ...
          {/* MIDDLE FOLD (Teal Ribbon, floats on alternative wave when active) */}
          <motion.path
            d="M 44.5,53.5 
          ...
          {/* RIGHT OVERLAY ACCENT (Mint/Emerald soar element) */}
          <motion.path
            d="M 64.5,33.5 
               L 75,54.5 
