...
export default function Hero({ onCtaClick }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-1/2 h-full bg-blue-50/55 rounded-l-[120px] pointer-events-none -skew-x-12 origin-top-right transition-all duration-1000 hidden md:block" />
      ...
      <div className="absolute top-24 left-1/2 w-8 h-8 rounded bg-gradient-to-tr from-blue-500/20 to-sky-400/20 border border-blue-500/10 pointer-events-none animate-3d-float opacity-70" />
        ...
        >
          ...
          >
            <span className="flex items-center gap-1.5">
              <Cube className="w-3.5 h-3.5 text-blue-600 animate-3d-float" />
